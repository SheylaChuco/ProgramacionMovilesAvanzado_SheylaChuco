...
let estacionesLinea2: [String: Estacion] = [
    "evitamiento": Estacion(nombre: "Evitamiento", linea: "L2", avenidas: ["Por definir"], tieneAscensores: true, tieneServiciosHigienicos: true, cantidadVagones: 6, conexiones: [], esProyectada: false, tarifa: tarifaL2, horario: horarioL2, sedesDeportivas: nil),
    "ovalo santa anita": Estacion(nombre: "Óvalo Santa Anita", linea: "L2", avenidas: ["Por definir"], tieneAscensores: true, tieneServiciosHigienicos: true, cantidadVagones: 6, conexiones: [], esProyectada: false, tarifa: tarifaL2, horario: horarioL2, sedesDeportivas: nil),
    "colectora industrial": Estacion(nombre: "Colectora Industrial", linea: "L2", avenidas: ["Por definir"], tieneAscensores: true, tieneServiciosHigienicos: true, cantidadVagones: 6, conexiones: [], esProyectada: false, tarifa: tarifaL2, horario: horarioL2, sedesDeportivas: nil),
    "hermilio valdizan": Estacion(nombre: "Hermilio Valdizán", linea: "L2", avenidas: ["Por definir"], tieneAscensores: true, tieneServiciosHigienicos: true, cantidadVagones: 6, conexiones: [], esProyectada: false, tarifa: tarifaL2, horario: horarioL2, sedesDeportivas: nil),
    "mercado santa anita": Estacion(nombre: "Mercado Santa Anita", linea: "L2", avenidas: ["Por definir"], tieneAscensores: true, tieneServiciosHigienicos: true, cantidadVagones: 6, conexiones: ["L4"], esProyectada: false, tarifa: tarifaL2, horario: horarioL2, sedesDeportivas: nil)
]
